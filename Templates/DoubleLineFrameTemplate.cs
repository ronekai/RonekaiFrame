...

{
...

    {
...

        {
            ...
            ctx.Draw(BrandThemeColors.FrameBorder, 2, new RectangleF(outer, outer, OutputSize.Width - outer * 2, OutputSize.Height - outer * 2));

            ctx.Draw(BrandThemeColors.AccentLine, 1, new RectangleF(inner - 4, inner - 4, OutputSize.Width - (inner - 4) * 2, OutputSize.Height - (inner - 4) * 2));
